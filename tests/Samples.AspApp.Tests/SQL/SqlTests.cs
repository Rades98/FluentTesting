...
namespace Samples.AspApp.Tests.SQL
{
    ...
    public class SqlTests(TestFixture fixture)
    {
        ...
        [Fact]
        public async Task SqlPutEndpointWithSnapshot_Should_ReturnOk()
        {
            //Create backup
            await fixture.ApplicationFactory.SnapshotMsSqlDatabasesAsync();
            ...
            //Restore data
            await fixture.ApplicationFactory.RestoreMsSqlFromSnapshotAsync();
