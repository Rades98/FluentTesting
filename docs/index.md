...
| 2.7.23|  | optimisation for toaster agents|
...
| 3.1.3 |  | NewClient fix |
| 3.1.4 |  | Return result of KillConnectionsAsync + allow getmssqlcontainer and eexc script usage |
| 3.1.5 |  | Get new http client |
